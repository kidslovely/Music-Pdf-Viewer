...
export default class VideoPlayer extends React.Component {
  ...
  render() {
    ...
    // const videoHeight = videoWidth * (9 / 16);
     ...
     const videoWidth =  Dimensions.get('window').width - 50;
    ...
    const TitleCenterView = ({ children, style, ...otherProps }) => (
      <View
        {...otherProps}
        style={[
          {
    ...
    const LeftView = ({ children, style, ...otherProps }) => (
      <Animated.View
        {...otherProps}
        style={[
          {
    ...
    const RightView = ({ children, style, ...otherProps }) => (
      <Animated.View
        {...otherProps}
        style={[
          {
    ...
    if(this.state.exit) return this.HIDDEN = true;
    else
    return (
          ...
          <View style = {{flex: 1 ,flexDirection:'row'}}>
            ...
            <TouchableWithoutFeedback 
              ...
              onPress={this._onSeekBarTap.bind(this)}>
                ...
                <Slider
                style={{ marginRight: 0, marginLeft: 20, flex: 1 }}
